...
## Read About
Dogshouse is a Telegram bot related to cryptocurrency, possibly a game or airdrop involving a token called $DOGS.
Dogs House bot might be used for claiming a free $DOGS airdrop, collecting in-game currency, or interacting with a crypto-related game.
Reward : For now you can only mine doghouse by invite more friends to accumulate more points.
And the points you get depends on the years of your activeness on telegram.
